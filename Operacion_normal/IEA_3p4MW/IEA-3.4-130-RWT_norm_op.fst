...
---------------------- INPUT FILES ---------------------------------------------
"IEA-3.4-130-RWT_ElastoDyn_Wang.dat" EDFile        - Name of file containing ElastoDyn input parameters (quoted string)
...
"v9_TI10/IEA-3.4-130-RWT_InflowFile_Wang_v9_TI10.dat" InflowFile    - Name of file containing inflow wind input parameters (quoted string)
...
"IEA-3.4-130-RWT_ServoDyn_norm_op.dat" ServoFile     - Name of file containing control and electrical-drive input parameters (quoted string)
