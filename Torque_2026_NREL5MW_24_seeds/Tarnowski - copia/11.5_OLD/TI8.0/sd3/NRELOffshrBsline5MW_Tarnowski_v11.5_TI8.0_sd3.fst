...
---------------------- INPUT FILES ---------------------------------------------
"NRELOffshrBsline5MW_ElastoDyn_Tarnowski_v11.5_TI8.0_sd3.dat"  EDFile        - Name of file containing ElastoDyn input parameters (quoted string)
...
"NRELOffshrBsline5MW_InflowFile_Tarnowski_v11.5_TI8.0_sd3.dat"  InflowFile    - Name of file containing inflow wind input parameters (quoted string)
...
"NRELOffshrBsline5MW_ServoDyn_Tarnowski_v11.5_TI8.0_sd3.dat"  ServoFile     - Name of file containing control and electrical-drive input parameters (quoted string)
