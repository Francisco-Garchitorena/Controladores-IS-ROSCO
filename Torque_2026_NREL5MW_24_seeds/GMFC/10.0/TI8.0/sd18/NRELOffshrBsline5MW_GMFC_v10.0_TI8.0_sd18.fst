...
---------------------- INPUT FILES ---------------------------------------------
"NRELOffshrBsline5MW_ElastoDyn_GMFC_v10.0_TI8.0_sd18.dat"  EDFile        - Name of file containing ElastoDyn input parameters (quoted string)
...
"NRELOffshrBsline5MW_InflowFile_GMFC_v10.0_TI8.0_sd18.dat"  InflowFile    - Name of file containing inflow wind input parameters (quoted string)
...
"NRELOffshrBsline5MW_ServoDyn_GMFC_v10.0_TI8.0_sd18.dat"  ServoFile     - Name of file containing control and electrical-drive input parameters (quoted string)
