...
---------------------- INPUT FILES ---------------------------------------------
"NRELOffshrBsline5MW_ElastoDyn_Norm_op_v11.0_TI8.0_sd9.dat"  EDFile        - Name of file containing ElastoDyn input parameters (quoted string)
...
"NRELOffshrBsline5MW_InflowFile_Norm_op_v11.0_TI8.0_sd9.dat"  InflowFile    - Name of file containing inflow wind input parameters (quoted string)
...
"NRELOffshrBsline5MW_ServoDyn_Norm_op_v11.0_TI8.0_sd9.dat"  ServoFile     - Name of file containing control and electrical-drive input parameters (quoted string)
