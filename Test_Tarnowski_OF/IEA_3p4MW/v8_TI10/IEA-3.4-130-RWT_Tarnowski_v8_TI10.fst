...
"IEA-3.4-130-RWT_InflowFile_Tarnowskii_v8_TI10.dat" InflowFile    - Name of file containing inflow wind input parameters (quoted string)
...
"../IEA-3.4-130-RWT_ServoDyn_Tarnowski.dat" ServoFile     - Name of file containing control and electrical-drive input parameters (quoted string)
