...
---------------------- INPUT FILES ---------------------------------------------
"../NRELOffshrBsline5MW_ElastoDyn_Tarnowski.dat" EDFile        - Name of file containing ElastoDyn input parameters (quoted string)
"C:/Users/fgarchitorena/OpenFast/Design Load Cases/DLCs_10_NREL/General/NRELOffshrBsline5MW_BeamDyn.dat" BDBldFile(1)  - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"C:/Users/fgarchitorena/OpenFast/Design Load Cases/DLCs_10_NREL/General/NRELOffshrBsline5MW_BeamDyn.dat" BDBldFile(2)  - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
"C:/Users/fgarchitorena/OpenFast/Design Load Cases/DLCs_10_NREL/General/NRELOffshrBsline5MW_BeamDyn.dat" BDBldFile(3)  - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
"NRELOffshrBsline5MW_InflowFile_Tarnowski_v8_TI10.dat" InflowFile    - Name of file containing inflow wind input parameters (quoted string)
"C:/Users/fgarchitorena/OpenFast/Design Load Cases/DLCs_10_NREL/General/NRELOffshrBsline5MW_AeroDyn15.dat" AeroFile      - Name of file containing aerodynamic input parameters (quoted string)
"../NRELOffshrBsline5MW_ServoDyn_Tarnowski.dat" ServoFile     - Name of file containing control and electrical-drive input parameters (quoted string)
