...
---------------------- INPUT FILES ---------------------------------------------
"../IEA-3.4-130-RWT_ElastoDyn_Tarnowski.dat" EDFile        - Name of file containing ElastoDyn input parameters (quoted string)
"C:/Users/fgarchitorena/OpenFast/Design Load Cases/DLCs_post_pro/General/IEA-3.4-130-RWT_BeamDyn.dat" BDBldFile(1)  - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"C:/Users/fgarchitorena/OpenFast/Design Load Cases/DLCs_post_pro/General/IEA-3.4-130-RWT_BeamDyn.dat" BDBldFile(2)  - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
"C:/Users/fgarchitorena/OpenFast/Design Load Cases/DLCs_post_pro/General/IEA-3.4-130-RWT_BeamDyn.dat" BDBldFile(3)  - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
"../IEA-3.4-130-RWT_InflowFile_Tarnowski.dat" InflowFile    - Name of file containing inflow wind input parameters (quoted string)
"C:/Users/fgarchitorena/OpenFast/Design Load Cases/DLCs_post_pro/General/IEA-3.4-130-RWT_AeroDyn15.dat" AeroFile      - Name of file containing aerodynamic input parameters (quoted string)
"IEA-3.4-130-RWT_ServoDyn_Tarnowski_dt_rise_05.dat" ServoFile     - Name of file containing control and electrical-drive input parameters (quoted string)
