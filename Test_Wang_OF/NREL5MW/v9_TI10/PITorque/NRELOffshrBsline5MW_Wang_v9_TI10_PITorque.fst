...
---------------------- INPUT FILES ---------------------------------------------
"../../NRELOffshrBsline5MW_ElastoDyn_Wang.dat" EDFile        - Name of file containing ElastoDyn input parameters (quoted string)
...
"../NRELOffshrBsline5MW_InflowFile_Wang_v9_TI10.dat" InflowFile    - Name of file containing inflow wind input parameters (quoted string)
...
"NRELOffshrBsline5MW_ServoDyn_PITorque.dat" ServoFile     - Name of file containing control and electrical-drive input parameters (quoted string)
