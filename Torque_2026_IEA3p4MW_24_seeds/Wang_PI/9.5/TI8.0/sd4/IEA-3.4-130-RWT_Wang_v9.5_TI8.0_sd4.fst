...
---------------------- INPUT FILES ---------------------------------------------
"IEA-3.4-130-RWT_ElastoDyn_Wang_v9.5_TI8.0_sd4.dat"  EDFile        - Name of file containing ElastoDyn input parameters (quoted string)
...
"IEA-3.4-130-RWT_InflowFile_Wang_v9.5_TI8.0_sd4.dat"  InflowFile    - Name of file containing inflow wind input parameters (quoted string)
...
"IEA-3.4-130-RWT_ServoDyn_Wang_v9.5_TI8.0_sd4.dat"  ServoFile     - Name of file containing control and electrical-drive input parameters (quoted string)
