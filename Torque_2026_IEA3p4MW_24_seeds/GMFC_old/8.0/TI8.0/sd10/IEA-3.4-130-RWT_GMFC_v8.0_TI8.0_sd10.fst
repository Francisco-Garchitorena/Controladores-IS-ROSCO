...
---------------------- INPUT FILES ---------------------------------------------
"IEA-3.4-130-RWT_ElastoDyn_GMFC_v8.0_TI8.0_sd10.dat"  EDFile        - Name of file containing ElastoDyn input parameters (quoted string)
...
"IEA-3.4-130-RWT_InflowFile_GMFC_v8.0_TI8.0_sd10.dat"  InflowFile    - Name of file containing inflow wind input parameters (quoted string)
...
"IEA-3.4-130-RWT_ServoDyn_GMFC_v8.0_TI8.0_sd10.dat"  ServoFile     - Name of file containing control and electrical-drive input parameters (quoted string)
