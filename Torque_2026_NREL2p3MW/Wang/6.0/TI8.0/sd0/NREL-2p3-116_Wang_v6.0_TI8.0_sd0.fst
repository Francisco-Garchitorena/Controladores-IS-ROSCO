...
---------------------- INPUT FILES ---------------------------------------------
"NREL-2p3-116_ElastoDyn_Wang_v6.0_TI8.0_sd0.dat"  EDFile        - Name of file containing ElastoDyn input parameters (quoted string)
...
"NREL-2p3-116_InflowFile_Wang_v6.0_TI8.0_sd0.dat"  InflowFile    - Name of file containing inflow wind input parameters (quoted string)
...
"NREL-2p3-116_ServoDyn_Wang_v6.0_TI8.0_sd0.dat"  ServoFile     - Name of file containing control and electrical-drive input parameters (quoted string)
