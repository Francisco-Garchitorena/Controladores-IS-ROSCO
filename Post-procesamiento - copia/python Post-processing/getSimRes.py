...
def getSimRes(simName, var, m, Teq, bins, start_index,end_index):
    '''
    Input:
   ...
   # print(fastoutFilename)
    ...
    # return Leq, S, N, bins, DELi, T, Mean_Gen_Pwr, max_var_value
    return equivalent_load(df['Time_[s]'][start_index:end_index], df[var][start_index:end_index], m=m, Teq=Teq, bins=bins, outputMore = True), max_var_value
