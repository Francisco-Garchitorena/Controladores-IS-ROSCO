...
% Estrategias
estrategias = {'Norm_op','Tarnowski','Wang','GMFC_5','GMFC_10'}; %
estrategia_names = {'Norm_op','Tarnowski','Wang','GMFC','GMFC'}; %
...
for v = 1:length(velocidades)
    ...
    for e = 1:length(estrategias)
        ...
        estrategia_name = estrategia_names{e};
        ...
        for sd = 1:length(seeds)
            ...
            file_path = fullfile(base_path, ...
                ...
                turbine_base_name + "_" + estrategia_name + "_" + Wind_Condition + ".outb");
...
save('IEA3p4MW_DELs_Max_means_per_seed_compare_DeltaTover_GMFCstrat.mat')