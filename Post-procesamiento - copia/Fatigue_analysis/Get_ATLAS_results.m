...
%% === CONFIGURACIÓN ===
archivo = 'ATLAS_IEA3p4MW/Results_summary_NREL5MW_journal_DLC1p3.csv';%'ATLAS_IEA3p4MW/Results_summary_KOMEGA2.csv'; %'ATLAS_IEA3p4MW/Results_summary_IEA_3p4_24seeds.csv'; % <-- cambiar por tu archivo
%'ATLAS_IEA3p4MW/Results_summary_NREL5MW_journal';
%% === LECTURA DE DATOS ===
